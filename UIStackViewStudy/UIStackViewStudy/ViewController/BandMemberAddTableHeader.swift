...
final class BandMemberAddTableHeader: UITableViewHeaderFooterView {
    ...
    private let inviteMemberButton = BasicButton(text: "멤버 초대")
    ...
    private lazy var titleVstack: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [stepLabel, titleLabel, subTitleLabel, buttonHstack])
